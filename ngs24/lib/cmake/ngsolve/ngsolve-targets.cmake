...
set_target_properties(ngs_lapack PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/opt/_internal/cpython-3.8.19/include"
...
set_target_properties(netgen_python PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/opt/_internal/cpython-3.8.19/include/python3.8"
)
...
set_target_properties(ngstd PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "HAVE_NETGEN_SOURCES;HAVE_DLFCN_H;HAVE_CXA_DEMANGLE;USE_TIMEOFDAY;TCL;LAPACK;USE_PARDISO;NGS_PYTHON"
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CXX>:-std=c++17>;-DMAX_SYS_DIM=3"
...
add_library(ngscudalib SHARED IMPORTED)

set_target_properties(ngscudalib PROPERTIES
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CUDA>:--expt-relaxed-constexpr;--extended-lambda;>"
  INTERFACE_LINK_LIBRARIES "CUDA::cusparse;CUDA::cublas;CUDA::cudart;ngsolve;netgen_python"
)
