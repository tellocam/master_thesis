...
\textsc{\Large Course Title - VO/VU/UE/SE}\\[0.5cm] % Major heading such as course name
\textsc{\large Institute where profs from course are from}\\[0.5cm] % Minor heading such as course title
...
\emph{Supervisor:} \\
Prof. Dr. Super \textsc{Visor} \\ % Supervisor's Name
\end{flushright}
\end{minipage}\\[1.5cm]
